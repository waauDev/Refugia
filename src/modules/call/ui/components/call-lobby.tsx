...
const AllowBrowserPermission = () =>{
    return(
        <p className="text-sm">
            Please Grant your browser a permission to access your camera and mic.
        </p>
    )
}
        ...
        <div className="flex min-h-svh flex-col items-center justify-center bg-radial from-sidebar-accent to-sidebar">
            <div className="py-4 px-8 flex flex-1 items-center justify-center">
                <div className="flex flex-col items-center justify-center gap-y-6 bg-background rounded-lg p-10 shadow-sm">
                    ...
                    <VideoPreview 
                        DisabledVideoPreview={hasBrowserPermission ? UserVideoPlaceholder: AllowBrowserPermission}
                        NoCameraPreview={UserVideoPlaceholder}
                    />
